...
public class UserFilter {
    ...
    public Specification<User> toSpecification() {
        return Specification.<User>where(null)
                .and(equalUuidSpecification(uuid))
                ...
                .and(greaterThanOrEqualToUserTypeSpecification(fromCreatedAt))
                .and(lessThanUserTypeSpecification(toCreatedAt));
    }

    //uuid
    private Specification<User> equalUuidSpecification(UUID uuid) {
    ...
    //from createdAt
    private Specification<User> greaterThanOrEqualToUserTypeSpecification(LocalDateTime localDateTime) {
        return (root, query, criteriaBuilder) -> {
    ...
    //to createdAt
    private Specification<User> lessThanUserTypeSpecification(LocalDateTime localDateTime) {
        return (root, query, criteriaBuilder) -> {
            if (localDateTime == null) {
                return null;
            }
